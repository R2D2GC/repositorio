...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
        ...
        $pu = $_POST['pu'];
        $cant=$_POST['cantidad'];
        $in = json_encode(array("id"=>$id,"nombre"=>$nom, "pu"=>$pu,"cantidad"=>$cant));
        $curl = curl_init();

       
        curl_setopt_array($curl, array(
            CURLOPT_URL => 'http://127.0.0.1/appwebOS/API_RESTFUL/PARCIAL2/api_restful/controllers/productos.php?op=update',
